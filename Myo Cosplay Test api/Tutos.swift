...
//
//  Created by haseeb khalid on 19/11/2016.
...
class Tutos: UITableViewController, UISearchBarDelegate {
    
    @IBOutlet weak var searchBar: UISearchBar!
    var posts = [pos]()
    var apiURL = "https://myocosplayeip.herokuapp.com/tuto"
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        searchURL = "https://myocosplayeip.herokuapp.com/tuto/titre/\(finalKeywords!)/"
            ...
            if let tutos = readableJSON["Tuto"] as? [JSONSTandard]{
                for i in 0..<tutos.count{
                    ...
                    if let images = readableJSON["Tuto"] as? [JSONSTandard]{
                        ...
                        posts.append(pos.init(mainImage: mainImage, name: name, id: id, contenu: contenu))
